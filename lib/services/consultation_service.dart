...
class ConsultationService {
  ...
  Future<http.Response> getDiagnosis(String consultationID) async {
    final String url = "${Api.API_BASE_URL}/diagnoses?consultation_id=$consultationID"; // TODO: Check in with backend
    final sessionID = await SecureStorageService().read('session_id');
  ...
  Future<http.Response> getSymptom(String consultationID) async {
    final String url = "${Api.API_BASE_URL}/symptom?consultation_id=$consultationID"; // TODO: Check in with backend
    final sessionID = await SecureStorageService().read('session_id');
  ...
  Future<http.Response> getPrescription(String consultationID) async {
    final String url = "${Api.API_BASE_URL}/prescription?consultation_id=$consultationID"; // TODO: Check in with backend
    final sessionID = await SecureStorageService().read('session_id');
